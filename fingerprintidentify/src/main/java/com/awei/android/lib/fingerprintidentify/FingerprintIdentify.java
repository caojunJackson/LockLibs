...
import com.awei.android.lib.fingerprintidentify.impl.AndroidFinger;
...
public class FingerprintIdentify {
    ...
    public FingerprintIdentify(Activity activity, FingerprintIdentifyExceptionListener
        ...
        AndroidFinger androidFingerprint2 = new AndroidFinger(activity, exceptionListener);
        if (androidFingerprint2.isHardwareEnable()) {
            mSubFingerprint = androidFingerprint2;
            if (androidFingerprint2.isRegisteredFinger()) {
                mFingerprint = androidFingerprint2;
                return;
            }
        }
